...
// platform specific opengl defines:
...
#define LOOP_GL_DECL_FUNC(DO)                                                                                   \
    DO(void, glDeleteBuffers, GLsizei, const GLuint *)                                                          \
    DO(void, glCreateBuffers, GLsizei, GLuint *)                                                                \
    DO(void, glNamedBufferData, GLuint, GLsizeiptr, const void *, GLenum)                                       \
    DO(void, glCopyNamedBufferSubData, GLuint, GLuint, GLintptr, GLintptr, GLsizeiptr)                          \
    DO(void, glNamedBufferSubData, GLuint, GLintptr, GLsizeiptr, const void *)                                  \
    DO(void, glCreateVertexArrays, GLsizei, GLuint *)                                                           \
    DO(void, glDeleteVertexArrays, GLsizei, const GLuint *)                                                     \
    DO(void, glEnableVertexArrayAttrib, GLuint, GLuint)                                                         \
    DO(void, glVertexArrayAttribBinding, GLuint, GLuint, GLuint)                                                \
    DO(void, glVertexArrayAttribFormat, GLuint, GLuint, GLint, GLenum, GLboolean, GLuint)                       \
    DO(void, glVertexArrayVertexBuffer, GLuint, GLuint, GLuint, GLintptr, GLsizei)                              \
    DO(void, glVertexArrayElementBuffer, GLuint, GLuint)                                                        \
    DO(void, glNamedBufferStorage, GLuint, GLsizeiptr, const void *, GLbitfield)                                \
